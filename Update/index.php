        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                while($siswa = mysqli_fetch_array($query)) {
                    ...
                    echo "<a href='index.php?edit=" . $siswa['id_pendaftaran'] . "' class='btn btn-info'>Edit</a>";
                  echo  " <a href='hapus.php?delete=" . $siswa['id_pendaftaran'] . "' class='btn btn-primary'>Delete</a>";
                        echo  "</td>";
                    echo "</tr>";
                }
                ?>
